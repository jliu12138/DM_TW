...
data = pd.read_csv('./data/reviews_detail.csv')
for i in range(len(data)):
    line=data.loc[i]
    line['positive_prob'] = lstm_predict(line['comments'])
    data_new = data_new.append(line)
data.to_csv('./data/reviews_processed.csv',index=False)